    ...
    <div className="modal fade" id="productModal" tabIndex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
      <div className="modal-dialog modal-xl">
        <div className="modal-content border-0">
          <div className={`modal-header bg-${modalType === 'delet' ? 'danger' : 'dark'} text-white`}>
            <h5 id="productModalLabel" className="modal-title">
              <span>{`${modalType === 'delet' ? '刪除' : modalType === 'edited' ? '編輯' : '新增'}`}產品</span>
            </h5>
            <button
              type="button"
              className="btn-close"
          ...
          <div className="modal-body">
            {
              modalType === 'delet' ? (
                ...
                <div className="col-sm-4">
                  ...
                  <div>
                    <button type="button" className="btn btn-outline-danger btn-sm d-block w-100"
          ...
          <div className="modal-footer">
            {
              modalType === 'delet' ? (<button
                type="button"
                className="btn btn-danger"
                onClick={() => deletProduct(tempData.id)}
              >刪除
              </button>) : (<>
                <button
                  type="button"
