...
const Regulation = () => {
    ...
    const [WelfareOpen, setWelfareOpen] = useState(null);
    // 用 useState 管理資料
    ...
    const togglePaymentOpen = (index) => {
        setPaymentOpen(PaymentOpen === index ? null : index);
    };

    const toggleWelfareOpen = (index) => {
        setWelfareOpen(WelfareOpen === index ? null : index);
    };
                ...
                <section>
                    <div className="container">
                        <div className="text-center pb-lg-11 pb-7">
                            <h2 className="fw-bold">員工福利及規範</h2>
                        </div>
                        <div className="row pb-100 mt-3">

                            <div className="col-lg-4 col-12 mb-5">
                                <div className="text-center pb-3">
                                    <p className="text-center px-5 py-14 fs-5 bg-white rounded-2 mb-3 text-gray-950">
                                        生日禮金/生日假
                                    </p>
                                    <div className="bg-primary text-white rounded-2 fs-8 px-5 pt-5 pb-5">
                                        <p className="lh-base">1.生日禮金為1000元</p>
                                        <p className="lh-base">2.生日假一天 (可任意使用不限當月也可以折換薪資)</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-4 col-12 mb-5">
                                <div className="text-center pb-3">
                                    <p className="text-center px-5 py-14 fs-5 rounded-2 mb-3 text-gray-950">勞健保員工自付額\團保</p>
                                    <div className="bg-secondary rounded-2 fs-8 px-5 pt-5 pb-5">
                                        <p className="lh-base">1.入職滿半年享有團保</p>
                                        <p className="lh-base">2.公司全額負擔勞健保</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-4 col-12">
                                <div className="text-center pb-3">
                                    <p className="text-center px-5 py-14 fs-5 bg-white rounded-2 mb-3 text-gray-950">藝文娛樂補助</p>
                                    <div className="bg-primary text-white rounded-2 fs-8 px-5 pt-5 pb-5">
                                        <p className="lh-base">1.通過三個月試用期者可享藝文補助福利</p>
                                        <p className="lh-base">2.每月600，一年 600*12 = 7,200 可累積使用</p>
                                        <p className="lh-base">3.有發票者需要打統編，無發票者需提供收據或相關證明</p>
                                        <p className="lh-base">4.有不確定的項目請事先詢問過Joey或姿琪</p>
                                        <p className="lh-base">5.向姿琪申請，於申請當月和薪資一起匯款</p>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            return (
                                                <div className="d-flex gap-3 mb-4" key={index}>
                                                    ...
                                                    <div className="flex-grow-1">
                                                        ...
                                                        {/* 根據 isOpen 狀態顯示 */}
                                                        {isOpen === index && (
                                                            <div className="dropdown-menu-custom w-100 border-0 p-5 bg-secondary mb-4 show text-start">
                                                                {/* 渲染 intro 文字 */}
                                                ...
                                                <div className="d-flex gap-3 mb-4" key={index}>
                                                    ...
                                                    <div className="flex-grow-1">
                                                        ...
                                                        <button
                                                            className="btn btn-white d-flex justify-content-between w-100 dropdown-toggle-custom mb-3 px-5 py-14 text-primary-hover fs-8"
                                                            type="button"
                                                            onClick={() => togglePaymentOpen(index)}
                                                        >
                                                            {item.question}
                                                            <span>
                                                                <img
                                                                    className="toggle-icon"
                                                                    src={PaymentOpen === index
                                                                        ? 'https://raw.githubusercontent.com/Fury51/img-base/0b8aa0769c819eab32b2865fa834b99de9f1ae25/%E5%9C%96%E5%BA%AB/faq-minus.svg'
                                                                        : 'https://raw.githubusercontent.com/Fury51/img-base/0b8aa0769c819eab32b2865fa834b99de9f1ae25/%E5%9C%96%E5%BA%AB/faq-plus.svg'}
                                                                    alt="plus&minus"
                                                                />
                                        ...
                                        {RegulationData.Welfare?.map((item, index) => {
                                            return (
                                                <div className="d-flex gap-3 mb-4" key={index}>
                                                    ...
                                                    <div className="flex-grow-1">
                                                        <button
                                                            className="btn  d-flex justify-content-between w-100 dropdown-toggle-custom mb-3 px-5 py-14 text-primary-hover fs-8"
                                                            type="button"
                                                            onClick={() => toggleWelfareOpen(index)}
                                                        >
                                                            {item.question}
                                                            <span>
                                                                <img
                                                                    className="toggle-icon"
                                                                    src={WelfareOpen === index
                                                                        ? 'https://raw.githubusercontent.com/Fury51/img-base/0b8aa0769c819eab32b2865fa834b99de9f1ae25/%E5%9C%96%E5%BA%AB/faq-minus.svg'
                                                                        : 'https://raw.githubusercontent.com/Fury51/img-base/0b8aa0769c819eab32b2865fa834b99de9f1ae25/%E5%9C%96%E5%BA%AB/faq-plus.svg'}
                                                                    alt=""
                                                                />
                    ...
                    <div className="container d-lg-none d-block">
                        ...
                        >
                            <div className="col-lg-3 col-12">
                                <ul className="nav nav-underline gap-1 flex-column" role="tablist">
                                    <li
                                        className="nav-item dashed-to-solid text-lg-start mb-lg-0 mb-4"
                                        role="presentation"
                                    >
                                        <button
                                            className="border-0 active bg-gray-50 text-color text-font lh-base"
                                ...
                                <div className="tab-pane fade show active">
                                    <div className="dropdown dropdown-push w-100">
                                        <div className="d-flex gap-3">
                                            ...
                                            <div className="flex-grow-1">
                                                {Regulation.Welfare?.map((item, index) => {
                                                    return (<div key={index}><button
                                                        className="btn btn-white d-flex justify-content-between w-100 dropdown-toggle-custom mb-3 px-5 py-14 text-primary-hover fs-8"
                                                        type="button"
                                                        data-bs-toggle="dropdown"
