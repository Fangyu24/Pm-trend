...
const OutsideLink = ({ isAdmin = false }) => {
    ...
    const deletData = async (Id) => {
        try {
            const res = await axios.delete(`${API_BASE}OutsideLink/${Id}`);
            console.log(res.data);
            const response = await axios.get(`${API_BASE}OutsideLink`);
            setoutsideLinkList(response.data);
        } catch (error) {
            console.log(error.message);
        }
    };
                ...
                <div key={index} className="col-4 mb-2 d-flex align-items-stretch">
                    <div className="card w-100">
                        ...
                        <div className="card-body d-flex flex-column flex-grow-1">
                            ...
                            <button
                                type="button"
                                className="btn btn-primary bg-hover"
                                onClick={(e) => {
